...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Gigaminton" },
      { name: "description", content: "Badminton score tracker for Giga Chads" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Gigaminton" },
      { property: "og:description", content: "Badminton score tracker for Giga Chads" },
      ...
      { name: "twitter:title", content: "Gigaminton" },
